/**
 * NexusTalent Platform Frontend Component: geofence_map_overlay.js
 * Subsystem: frontend_components - Interactive Geofencing Polygon & Coordinate Drawing Widget
 * Glassmorphic reactive dashboard component with real-time state machine bindings.
 */

export class GeofenceMapOverlay {
    ...
    init() {
        ...
        console.log(`[Component Initialized]: geofence_map_overlay.js`);
    }
        ...
        this.container.innerHTML = `
            <div class="nt-card nt-glassmorphic">
                <div class="nt-card-header">
                    <h3 class="nt-title"><i class="fas fa-cubes"></i> Interactive Geofencing Polygon & Coordinate Drawing Widget</h3>
