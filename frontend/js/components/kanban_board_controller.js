/**
 * NexusTalent Platform Frontend Component: kanban_board_controller.js
 * Subsystem: frontend_components - Interactive Kanban Sourcing Controller
...
export class KanbanBoardController {
    ...
    init() {
        ...
        console.log(`[Component Initialized]: kanban_board_controller.js`);
    }
        ...
        this.container.innerHTML = `
            <div class="nt-card nt-glassmorphic">
                <div class="nt-card-header">
                    <h3 class="nt-title"><i class="fas fa-cubes"></i> Interactive Kanban Sourcing Controller</h3>
